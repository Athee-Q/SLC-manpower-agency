  ...
  return (
    <section className="relative  bg-background dark:bg-dark-background  dark:text-dark-text overflow-hidden">
      ...
      <motion.div
        ...
        className=" relative grid grid-cols-12 bg-primary dark:bg-dark-primary text-white z-10 w-[100vw] p-6 md:p-8 lg:p-10 "
      >
        <div className="col-span-6 flex flex-col items-start justify-center p-6 md:p-8 lg:p-10  ">
          ...
          >
            ...
            believe in prompt, personalized support that actually solves
            problems.
            <br />
            <br />
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
            <Link
              href="#contact"
              className="px-6 py-3 text-center text-nowrap rounded-xl font-semibold text-white bg-background/30 dark:bg-dark-background/30 cursor-pointer hover:bg-accent dark:hover:bg-dark-accent transition-colors"
            >
              Contact Support
            </Link>
          </motion.div>
